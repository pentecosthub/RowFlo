...
> **Note:** RowFlo uses WaterRower's native Bluetooth Low Energy protocol for r>
> An FTMS implementation was attempted but abandoned due to data flow issues. S>

## What RowFlo Does

RowFlo is a stable, device-neutral Linux application that:
- Reads WaterRower S4 monitor data via USB serial connection
- Broadcasts rowing metrics via Bluetooth Low Energy using WaterRower's native >
- Works on any Linux system (Ubuntu, Debian, Raspberry Pi OS)
- Auto-starts on boot and runs headless
